...
public class MergeSortWithInsertion<T extends Comparable<? super T>>{
	/** Procedure to sort by insertion after a threshold level
	...
	public static void main(String[] args) {		
		...
		n = in.nextInt();
		MergeSortWithInsertion<Integer> ms = new MergeSortWithInsertion<>();
